    ...
    <div class="container-xl">
        <div class="card">
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <span class="btn btn-{{ $purchase->status == 1 ? 'success' : 'warning' }} btn-sm text-uppercase">
                                    {{ $purchase->status == 1 ? 'Approved' : 'Pending' }}
                                </span>
                            </td>
                            <td class="align-middle text-center">
                                <a href="{{ route('purchases.show', $purchase->id) }}" class="btn btn-icon btn-outline-info">
            ...
            <div class="card-footer">
                <!-- Optional: pagination or any footer actions -->
            </div>
        </div>
    </div>
</div>
